{{-- Footer partilhado — usado em welcome.blade.php e lumina-layout.blade.php --}}
<footer class="bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 pt-20 {{ $bottomPadding ?? 'pb-10' }} transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="border-t border-slate-100 dark:border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center">
            <p class="text-xs text-slate-400">&copy; {{ date('Y') }} Lumina Portugal. Todos os direitos reservados.</p>
