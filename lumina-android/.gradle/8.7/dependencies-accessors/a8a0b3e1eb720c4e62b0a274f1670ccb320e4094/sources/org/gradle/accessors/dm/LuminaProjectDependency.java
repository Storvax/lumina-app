...
@NonNullApi
public class LuminaProjectDependency extends DelegatingProjectDependency {

    @Inject
    public LuminaProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
